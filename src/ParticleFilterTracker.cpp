...
ParticleFilterTracker::ParticleFilterTracker(Point detection,
                                             MatND histogram,
...
void ParticleFilterTracker::measurement(Point detection, MatND histogram)
{
...
void ParticleFilterTracker::assignDetection(Point detection, MatND histogram)
{
...
Point ParticleFilterTracker::getPos()
{
    if(pastStates.empty())
        return Point(0,0);
    State cur =  pastStates.back();
    return Point((int)cur.x,(int)cur.y);
}
...
void ParticleFilterTracker::initialize(Point detection)
{
    double init = 1.0/noParticles;
    for(int i=0;i<noParticles;i++)
    {
